...
namespace QLNhaTro
{
    public partial class frmMain : Form
    {
        ...
        private void danhSáchKháchTrongPhòngToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        {
            var f = new frmDSPhong();
            addForm(f);
        }

        private void danhSáchThuêPhòngToolStripMenuItem_Click(object sender, EventArgs e)
        {
            var f = new frmDSThuePhong();
            addForm(f);
        }

        private void danhSáchTrảPhòngToolStripMenuItem_Click(object sender, EventArgs e)
        {
            var f = new frmDSTraPhong();
            addForm(f);
        }

        private void danhSáchHóaĐơnToolStripMenuItem_Click(object sender, EventArgs e)
        {
            var f = new frmDSHoaDon();
            addForm(f);
        }
    }
}
